...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-list-view-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:05:11 GMT -->
<head>
	<meta charset="utf-8">
					...
					<div class="col-xl-3">
						<div class="shop-filter">
								...
								<div class="accordion-item">
									...
									<div id="collapseTwo" class="accordion-collapse collapse accordion-body" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
										<div class="widget dz-widget_services">
											<div class="form-check search-content">
												<input class="form-check-input" type="checkbox" value="" id="productCheckBox-015">
												<label class="form-check-label" for="productCheckBox-015">
													Action
												</label>
											</div>
											<div class="form-check search-content">
												<input class="form-check-input" type="checkbox" value="" id="productCheckBox-016">
												<label class="form-check-label" for="productCheckBox-016">
													Advanture
												</label>
											</div>
											<div class="form-check search-content">
												<input class="form-check-input" type="checkbox" value="" id="productCheckBox-017">
												<label class="form-check-label" for="productCheckBox-017">
													Animation
												</label>
											</div>
											<div class="form-check search-content">
												<input class="form-check-input" type="checkbox" value="" id="productCheckBox-018">
												<label class="form-check-label" for="productCheckBox-018">
													Biography
												</label>
											</div>
											<div class="form-check search-content">
												<input class="form-check-input" type="checkbox" value="" id="productCheckBox-019">
												<label class="form-check-label" for="productCheckBox-019">
													Comedy
												</label>
											</div>
											<div class="form-check search-content">
												<input class="form-check-input" type="checkbox" value="" id="productCheckBox-020">
												<label class="form-check-label" for="productCheckBox-020">
													Crime
												</label>
											</div>
											<div class="form-check search-content">
												<input class="form-check-input" type="checkbox" value="" id="productCheckBox-021">
												<label class="form-check-label" for="productCheckBox-021">
													Documentary
												</label>
											</div>
										</div>
							...
							<div class="row filter-buttons">
								<div>
									<a href="javascript:void(0);" class="btn btn-secondary mt-4 btnhover d-block">Refine Search</a>
							...
							<div class="dz-shop-card style-2">
								...
								<div class="dz-content">
									<div class="dz-header">
										<div>
											<ul class="dz-tags">
												<li><a href="books-list-view-sidebar.php">ADVANTURE,</a></li>
												<li><a href="books-list-view-sidebar.php">SCIENCE,</a></li>
												<li><a href="books-list-view-sidebar.php">COMEDY</a></li>
											</ul>
											<h4 class="title mb-0"><a href="books-list-view-sidebar.php">The Missadventure of David</a></h4>
										</div>
										<div class="price">
											<span class="price-num text-primary">$54.78</span>
											<del>$70.00</del>
										</div>
									</div>
									...
									<div class="dz-body">
										<div class="dz-rating-box">
											<div>
												<p class="dz-para">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type. </p>
												<div>
													<a href="pricing.php" class="badge">Get 20% Discount for today</a>
													<a href="pricing.php" class="badge">50% OFF Discount</a>
													<a href="pricing.php" class="badge next-badge">See 2+ promos</a>
												</div>
											</div>
										...
										<div class="rate">
											...
											<div class="d-flex">
												<a href="shop-cart.php" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								...
								<div class="dz-content">
									<div class="dz-header">
										<div>
											...
											<h4 class="title mb-0"><a href="books-list-view-sidebar.php">Terrible Madness</a></h4>
										</div>
										<div class="price">
											<span class="price-num text-primary">$75.78</span>
											<del>$37.00</del>
										</div>
									</div>
									...
									<div class="dz-body">
										...
										<div class="rate">
											...
											<div class="d-flex">
												<a href="shop-cart.php" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
												<div class="bookmark-btn style-1">
													<input class="form-check-input" type="checkbox" id="flexCheckDefault20">
								...
								<div class="dz-content">
									<div class="dz-header">
										<div>
											...
											<h4 class="title mb-0"><a href="books-list-view-sidebar.php">All Good News</a></h4>
										</div>
										<div class="price">
											<span class="price-num text-primary">$50.78</span>
											<del>$80.00</del>
										</div>
									</div>
									...
									<div class="dz-body">
										...
										<div class="rate">
											...
											<div class="d-flex">
												<a href="shop-cart.php" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
												<div class="bookmark-btn style-1">
													<input class="form-check-input" type="checkbox" id="flexCheckDefault30">
								...
								<div class="dz-content">
									<div class="dz-header">
										<div>
											...
											<h4 class="title mb-0"><a href="books-list-view-sidebar.php">Thunder Stunt</a></h4>
										</div>
										<div class="price">
											<span class="price-num text-primary">$72.78</span>
											<del>$50.00</del>
										</div>
									</div>
									...
									<div class="dz-body">
										...
										<div class="rate">
											...
											<div class="d-flex">
												<a href="shop-cart.php" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
												<div class="bookmark-btn style-1">
													<input class="form-check-input" type="checkbox" id="flexCheckDefault40">
								...
								<div class="dz-content">
									<div class="dz-header">
										<div>
											...
											<h4 class="title mb-0"><a href="books-list-view-sidebar.php">Battle Drive</a></h4>
										</div>
										<div class="price">
											<span class="price-num text-primary">$89.23</span>
											<del>$62.00</del>
										</div>
									</div>
									...
									<div class="dz-body">
										...
										<div class="rate">
											...
											<div class="d-flex">
												<a href="shop-cart.php" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
												<div class="bookmark-btn style-1">
													<input class="form-check-input" type="checkbox" id="flexCheckDefault50">
									...
									<div class="dz-body">
										...
										<div class="rate">
											...
											<div class="d-flex">
												<a href="shop-cart.php" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
												<div class="bookmark-btn style-1">
													<input class="form-check-input" type="checkbox" id="flexCheckDefault60">
