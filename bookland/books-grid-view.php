...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-grid-view.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:05:07 GMT -->
<head>
	<meta charset="utf-8">
				...
				<div class="row book-grid-row">
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">The Missadventure</a></h5>
								<ul class="dz-tags">
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							<div class="dz-media">
								<img src="images/books/grid/book8.jpg" alt="book">										
							</div>
							<div class="bookmark-btn style-2">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">The Adventure</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">ADVENTURE</a></li>
								</ul>
								<ul class="dz-rating">
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$89.0</span>
										<del>$63.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">A Heavy Lift</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">HORROR,</a></li>
									<li><a href="books-grid-view.php">DRAMA</a></li>
								</ul>
								<ul class="dz-rating">
									<li><i class="flaticon-star text-yellow"></i></li>	
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$52.0</span>
										<del>$23.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">Terrible Madness</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">SPORTS,</a></li>
									<li><a href="books-grid-view.php">DRAMA</a></li>
								</ul>
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$46.3</span>
										<del>$42.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">Such Fun Age</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">THRILLER</a></li>
								</ul>
								<ul class="dz-rating">
									<li><i class="flaticon-star text-yellow"></i></li>	
									<li><i class="flaticon-star text-yellow"></i></li>	
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$55.5</span>
										<del>$36.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">Pushing Clouds</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">DRAMA,</a></li>
									<li><a href="books-grid-view.php">COMEDY</a></li>
								</ul>
								<ul class="dz-rating">
									<li><i class="flaticon-star text-yellow"></i></li>	
									<li><i class="flaticon-star text-yellow"></i></li>	
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$39.5</span>
										<del>$54.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">Homie</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">DRAMA,</a></li>
									<li><a href="books-grid-view.php">COMEDY</a></li>
								</ul>
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$25.0</span>
										<del>$40.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">SECONDS</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">THRILLER</a></li>
								</ul>
								<ul class="dz-rating">
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$40.0</span>
										<del>$32.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">REWORK</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">DRAMA,</a></li>
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$60.5</span>
										<del>$32.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">ALL GOOD NEWS</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">BIOGRAPHY</a></li>
								</ul>
								<ul class="dz-rating">
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$92.0</span>
										<del>$82.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">Emily The Back</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">DRAMA,</a></li>
									<li><a href="books-grid-view.php">BIOGRAPHY</a></li>
								</ul>
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$19.5</span>
										<del>$12.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
					...
					<div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.php">Real Life</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.php">DRAMA,</a></li>
									<li><a href="books-grid-view.php">BIOGRAPHY</a></li>
								</ul>
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">$ 66.0</span>
										<del>$52.0</del>
									</div>
									<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-grid-view.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:05:10 GMT -->
</html>