...
<!-- Mirrored from bookland.dexignzone.com/xhtml/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:04:53 GMT -->
<head>
										...
										<div class="swiper-content">
											<div class="content-info">
												...
												<div class="content-btn" data-swiper-parallax="-60">
													...
													<a class="btn btn-outline-secondary btnhover ms-4" href="books-detail.php">See Details</a>
												</div>
											</div>
											<div class="partner">
												<p>Our partner</p>
				...
				<div class="row about-style1 align-items-center">
					...
					<div class="col-lg-6 m-b30 wow fadeInUp" data-wow-delay="0.2s">
						<div class="about-content px-lg-4">
							...
							<a href="contact-us.php" class="btn btn-primary shadow-primary btnhover">Contact Us</a>
						</div>
					</div>
				</div>
				<!--Client Swiper -->
					...
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
						<div class="icon-bx-wraper style-3 m-b30">
							...
							<div class="icon-content">
								...
								<a href="about-us.php">Learn More <i class="fa-solid fa-angles-right"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="books-card style-3 wow fadeInUp" data-wow-delay="0.3s">
								...
								<div class="dz-content">
									<h5 class="title"><a href="books-grid-view.php">Seconds [PART 1]</a></h5>
									<ul class="dz-tags">
										<li><a href="books-grid-view.php">SPORTS,</a></li>
										<li><a href="books-grid-view.php">DRAMA</a></li>
									</ul>
						...
						<div class="swiper-slide">
							<div class="books-card style-3 wow fadeInUp" data-wow-delay="0.6s">
								...
								<div class="dz-content">
									<h5 class="title"><a href="books-grid-view.php">Battle Drive</a></h5>
									<ul class="dz-tags">
										<li><a href="books-grid-view.php">SPORTS,</a></li>
										<li><a href="books-grid-view.php">DRAMA</a></li>
									</ul>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.1s">
								<div class="dz-media">
									<a href="books-detail.php"><img src="images/blog/blog5.jpg" alt="/"></a>
								</div>
								<div class="dz-info">
									<h4 class="dz-title"><a href="books-detail.php">SECONDS [Part I]</a></h4>
									<div class="dz-meta">
										<ul class="dz-tags">
											<li><a href="books-detail.php">BIOGRAPHY</a></li>
											<li><a href="books-detail.php">THRILLER</a></li>
											<li><a href="books-detail.php">HORROR</a></li>
										</ul>
									</div>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
									<div class="bookcard-footer">
										<a href="shop-cart.php" class="btn btn-primary m-t15 btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
						...
						<div class="swiper-slide">
							<div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.2s">
								<div class="dz-media">
									<a href="books-detail.php"><img src="images/blog/blog6.jpg" alt="/"></a>
								</div>
								<div class="dz-info">
									<h4 class="dz-title"><a href="books-detail.php">Terrible Madness</a></h4>
									<div class="dz-tags">
										<ul>
											<li><a href="books-detail.php">BIOGRAPHY</a></li>
											<li><a href="books-detail.php">THRILLER</a></li>
						...
						<div class="swiper-slide">
							<div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.3s">
								<div class="dz-media">
									<a href="books-detail.php"><img src="images/blog/blog7.jpg" alt="/"></a>
								</div>
								<div class="dz-info">
									<h4 class="dz-title"><a href="books-detail.php">REWORK</a></h4>
									<div class="dz-tags">
										<ul>
											<li><a href="books-detail.php">BIOGRAPHY</a></li>
											<li><a href="books-detail.php">THRILLER</a></li>
						...
						<div class="pricingtable-wrapper mt-0 style-1 m-b30">
							<div class="pricingtable-inner">
								...
								<div class="pricingtable-footer"> 
									<a href="pricing.php" class="btn btn-primary btnhover3">Start Now <i class="fa fa-angle-right m-l10"></i></a> 
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-3 col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
						<div class="widget widget_about">
							<div class="footer-logo logo-white">
								<a href="index-2.php"><img src="images/logo-white.png" alt=""></a> 
							</div>
...
<!-- Mirrored from bookland.dexignzone.com/xhtml/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:04:56 GMT -->
</html>