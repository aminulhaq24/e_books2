...
<!-- Mirrored from bookland.dexignzone.com/xhtml/shop-cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:04:51 GMT -->
<head>
	<meta charset="utf-8">
					...
					<div class="col-lg-6">
						<div class="widget">
							<form class="shop-form"> 
								...
								<div class="form-group">
									<a href="shop-cart.php" class="btn btn-primary btnhover" type="button">Apply Coupon</a>
								</div>
							</form>	
						</div>
					</div>
