...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-grid-view-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:05:10 GMT -->
<head>
	<meta charset="utf-8">
							...
							<li class="nav-item dropdown profile-dropdown  ms-4">
								...
								<div class="dropdown-menu py-0 dropdown-menu-end">
									...
									<div class="dropdown-body">
										...
										<a href="shop-cart.php" class="dropdown-item d-flex justify-content-between align-items-center ai-icon">
											<div>
									...
									<div class="dropdown-footer">
										<a class="btn btn-primary w-100 btnhover btn-sm" href="shop-login.php">Log Out</a>
									</div>
								</div>
							</li>
						</ul>
					...
					<div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
						...
						<ul class="nav navbar-nav">
							...
							<li class="sub-menu-down"><a href="javascript:void(0);"><span>Shop</span></a>
								<ul class="sub-menu">
									<li><a href="books-grid-view.php">Shop Grid</a></li>
					...
					<div class="col-xl-9">
						...
						<div class="acod-content collapse " id="collapseExample">
							<div class="widget widget_services style-2">
								...
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox02">
									<label class="form-check-label" for="productCheckBox02">
										Art
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox03">
									<label class="form-check-label" for="productCheckBox03">
										Action
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox04">
									<label class="form-check-label" for="productCheckBox04">
										Biography & Autobiography
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox05">
									<label class="form-check-label" for="productCheckBox05">
										Body, Mind & Spirit
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox06">
									<label class="form-check-label" for="productCheckBox06">
										Business & Economics
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox07">
									<label class="form-check-label" for="productCheckBox07">
										Children Fiction
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox08">
									<label class="form-check-label" for="productCheckBox08">
										Children Non-Fiction
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox09">
									<label class="form-check-label" for="productCheckBox09">
										Comics & Graphic Novels
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox010">
									<label class="form-check-label" for="productCheckBox010">
										Cooking
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox011">
									<label class="form-check-label" for="productCheckBox011">
										Crafts & Hobbies
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox012">
									<label class="form-check-label" for="productCheckBox012">
										Design
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox013">
									<label class="form-check-label" for="productCheckBox013">
										Drama
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox014">
									<label class="form-check-label" for="productCheckBox014">
										Education
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox015">
									<label class="form-check-label" for="productCheckBox015">
										Family & Relationships
									</label>
								</div>						
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox016">
									<label class="form-check-label" for="productCheckBox016">
										Fiction
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox017">
									<label class="form-check-label" for="productCheckBox017">
										Foreign Language Study
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox018">
									<label class="form-check-label" for="productCheckBox018">
										Games
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox019">
									<label class="form-check-label" for="productCheckBox019">
										Gardening
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox020">
									<label class="form-check-label" for="productCheckBox020">
										Health & Fitness
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox021">
									<label class="form-check-label" for="productCheckBox021">
										History
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox022">
									<label class="form-check-label" for="productCheckBox022">
										House & Home
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox023">
									<label class="form-check-label" for="productCheckBox023">
										Humor
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox024">
									<label class="form-check-label" for="productCheckBox024">
										Literary Collections
									</label>
								</div>
								<div class="form-check search-content">
									<input class="form-check-input" type="checkbox" value="" id="productCheckBox025">
									<label class="form-check-label" for="productCheckBox025">
										Mathematics
									</label>
								</div>
							</div>
						...
						<div class="row book-grid-row">
							<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									...
									<div class="dz-content">
										<h5 class="title"><a href="books-grid-view.php">Thunder Stunt</a></h5>
										<ul class="dz-tags">
											<li><a href="books-grid-view.php">ADVANTURE,</a></li>
											<li><a href="books-grid-view.php">SCIENCE,</a></li>
										</ul>
										<ul class="dz-rating">
										...
										<div class="book-footer">
											...
											<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									...
									<div class="dz-content">
										<h5 class="title"><a href="books-grid-view.php">Battler Drive</a></h5>
										<ul class="dz-tags">
											<li><a href="books-grid-view.php">RACING,</a></li>
											<li><a href="books-grid-view.php">DRAMA</a></li>
										</ul>
										<ul class="dz-rating">
											<li><i class="flaticon-star text-yellow"></i></li>	
											<li><i class="flaticon-star text-yellow"></i></li>	
										...
										<div class="book-footer">
											<div class="price">
												<span class="price-num">$60.09</span>
												<del>$12.0</del>
											</div>
											<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
										</div>
							...
							<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									<div class="dz-media">
										<img src="images/books/grid/book4.jpg" alt="book">										
									</div>
									<div class="bookmark-btn style-2">
									...
									<div class="dz-content">
										<h5 class="title"><a href="books-grid-view.php">Take Out Tango</a></h5>
										<ul class="dz-tags">
											<li><a href="books-grid-view.php">SPORTS,</a></li>
											<li><a href="books-grid-view.php">DRAMA</a></li>
										</ul>
										<ul class="dz-rating">
											<li><i class="flaticon-star text-yellow"></i></li>	
										...
										<div class="book-footer">
											<div class="price">
												<span class="price-num">$12.05</span>
												<del>$54.0</del>
											</div>
											<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
										</div>
							...
							<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									...
									<div class="dz-content">
										<h5 class="title"><a href="books-grid-view.php">Missadventure</a></h5>
										<ul class="dz-tags">
											<li><a href="books-grid-view.php">ADVENTURE</a></li>
										</ul>
										<ul class="dz-rating">
											<li><i class="flaticon-star text-yellow"></i></li>	
											<li><i class="flaticon-star text-yellow"></i></li>	
										...
										<div class="book-footer">
											<div class="price">
												<span class="price-num">$53.0</span>
												<del>$44.0</del>
											</div>
											<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
										</div>
							...
							<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									<div class="dz-media">
										<img src="images/books/grid/book13.jpg" alt="book">										
									</div>
									<div class="bookmark-btn style-2">
							...
							<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									<div class="dz-media">
										<img src="images/books/grid/book10.jpg" alt="book">										
									</div>
									<div class="bookmark-btn style-2">
							...
							<div class="col-book style-2">
								<div class="dz-shop-card style-1">
									...
									<div class="dz-content">
										...
										<div class="book-footer">
											<div class="price">
												<span class="price-num">$54.78</span>
												<del>$70.00</del>
											</div>
											<a href="shop-cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
										</div>
				...
				<div class="category-toggle">
					...
					<div class="toggle-items row book-grid-row">
						<div class="footer-col-book">
							<ul>
								<li><a href="books-grid-view.php">Architecture</a></li>
								<li><a href="books-grid-view.php">Art</a></li>
								<li><a href="books-grid-view.php">Action</a></li>
								<li><a href="books-grid-view.php">Biography</a></li>
								<li><a href="books-grid-view.php">Body, Mind & Spirit</a></li>
								<li><a href="books-grid-view.php">Business & Economics</a></li>
								<li><a href="books-grid-view.php">Children Fiction</a></li>
								<li><a href="books-grid-view.php">Children Non-Fiction</a></li>
								<li><a href="books-grid-view.php">Comics & Graphics</a></li>
								<li><a href="books-grid-view.php">Cooking</a></li>
								<li><a href="books-grid-view.php">Crafts & Hobbies</a></li>
								<li><a href="books-grid-view.php">Design</a></li>
								<li><a href="books-grid-view.php">Drama</a></li>
								<li><a href="books-grid-view.php">Education</a></li>
								<li><a href="books-grid-view.php">Family & Relationships</a></li>
								<li><a href="books-grid-view.php">Fiction</a></li>
								<li><a href="books-grid-view.php">Foreign Language</a></li>
								<li><a href="books-grid-view.php">Games</a></li>
								<li><a href="books-grid-view.php">Gardening</a></li>
								<li><a href="books-grid-view.php">Health & Fitness</a></li>
								<li><a href="books-grid-view.php">History</a></li>
								<li><a href="books-grid-view.php">House & Home</a></li>
								<li><a href="books-grid-view.php">Humor</a></li>
								<li><a href="books-grid-view.php">Literary Collections</a></li>
								<li><a href="books-grid-view.php">Mathematics</a></li>
								<li><a href="books-grid-view.php">Medical</a></li>
								<li><a href="books-grid-view.php">Nature</a></li>
								<li><a href="books-grid-view.php">Performing Arts</a></li>
								<li><a href="books-grid-view.php">Pets</a></li>
								<li><a href="books-grid-view.php">Show others</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-xl-2 col-lg-3 col-sm-4 col-4">
						<div class="widget widget_services">
							...
							<ul>
								<li><a href="index-2.php">Bookland</a></li>
								<li><a href="services.php">Services</a></li>
...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-grid-view-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Dec 2024 20:05:11 GMT -->
</html>