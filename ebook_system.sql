...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2025 at 08:59 AM
...
INSERT INTO `books` (`book_id`, `title`, `author`, `category_id`, `subcategory_id`, `description`, `cover_image`, `pdf_file`, `soft_copy_file`, `cd_available`, `price`, `created_at`) VALUES
(1, 'Islamic Moral Values', 'Amin ul haq', 22, 8, 'lorem ipsum was good enough cold war', '1764562520_pic 1 customer (4).jpg', '1764562520_pq2.docx', '', 'No', 0, '2025-12-01 04:15:20'),
(4, 'Bang e dara', 'Allama Iqbal', 22, 18, 'This is one of the most popular poetry book in South Asia and the entire world as well.', '1765009231_metal wall13.webp', '1765009231_pq2.docx', '', 'Yes', 600, '2025-12-06 08:20:31'),
(5, 'X-men 3', 'taimoor', 22, 18, 'nice book ever never', '1765023285_metal wall14.webp', '', '', 'No', 788, '2025-12-06 12:14:45'),
(6, 'jghjg hbm99', 'wahab', 22, 11, 'gv jkkj khlknjl', '1765213279_wall paper6.webp', '1765213279_User Guide for Jensen Decors.docx', '', 'No', 980, '2025-12-08 17:01:19'),
(7, 'dsf bkbk jnkk', 'Anwar', 22, 11, 'chg bhjkj jbjk', '1765213448_metal wall9.webp', '', '', 'Yes', 0, '2025-12-08 17:04:08');
...
INSERT INTO `competitions` (`id`, `title`, `type`, `start_datetime`, `end_datetime`, `description`, `image`, `first_prize`, `second_prize`, `third_prize`, `created_at`) VALUES
(1, 'annual comp', 'Essay', '2025-12-10 12:30:00', '2025-12-22 12:30:00', 'sc fgfd ggf hjghj jy', NULL, '5000', '0', '0', '2025-12-02 07:09:41'),
(3, 'ewre', 'Quiz', '2025-12-05 12:35:00', '2025-12-25 12:35:00', 'ghhg bhjb wdw pip xz lkl', NULL, '', '5000', '3000', '2025-12-02 07:36:29'),
(4, 'weregtrt', 'Story Writing', '2025-12-05 12:38:00', '2025-12-28 12:38:00', 'dwad nh cxx uju ikol', NULL, '6000', '5000', '3000', '2025-12-02 07:38:45'),
(13, 'jghj', 'Story Writing', '2026-01-06 18:34:00', '2025-12-30 18:34:00', 'gfdg hkhu cxf iu iohjo', NULL, '7888', '5666', '2334', '2025-12-02 13:35:24');
...
CREATE TABLE `orders` (
  ...
  `order_type` enum('pdf','cd','hardcopy') DEFAULT NULL,
